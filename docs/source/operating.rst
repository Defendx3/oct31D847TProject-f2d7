[oct31D847TProject-f2d7] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [oct31D847TProject-f2d7] container is NOT running**.

.. tip::
   You must have your [oct31D847TProject-f2d7] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Defendx3/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=43809  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Defendx3'  \-\-env DOCKERUSERNAME='defendx'  \-\-env MQTTUSERNAME='defendx3@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=33849
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=50843
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - defendx/oct31D847TProject-f2d7-amd64
...
It can be accessed by entering: http://localhost:35599
...
.. important::
   http://localhost:33849/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:33849/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:33849/<html file>
...
[oct31D847TProject-f2d7] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Defendx3/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/oct31D847TProject-f2d7
...
.. important::
   solution_preprocessing_dag-oct31D847TProject-f2d7
...
.. important::
   VIPERHOST_PRODUCE=192.168.49.1, VIPERPORT_PRODUCE=50843, VIPERHOST_PREPOCESS=192.168.49.1, VIPERPORT_PREPROCESS=38913, VIPERHOST_PREPOCESS2=192.168.49.1, VIPERPORT_PREPROCESS2=43337, VIPERHOST_PREPOCESS_PGPT=192.168.49.1, VIPERPORT_PREPROCESS_PGPT=44251, VIPERHOST_ML=192.168.49.1, VIPERPORT_ML=35605, VIPERHOST_PREDCT=192.168.49.1, VIPERPORT_PREDICT=34367, HPDEHOST=192.168.49.1, HPDEPORT=42433, HPDEHOST_PREDICT=192.168.49.1, HPDEPORT_PREDICT=34755

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3384-oct31D847TProject-f2d7,solution_preprocessing_dag-oct31D847TProject-f2d7, python-preprocess-5320-oct31D847TProject-f2d7,solution_preprocessing_dag-oct31D847TProject-f2d7, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
